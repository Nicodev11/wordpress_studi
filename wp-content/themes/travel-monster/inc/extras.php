...
if (!function_exists('travel_monster_posted_by')):
    ...
    function travel_monster_posted_by() {
        ...
        esc_html_x('%s', 'post author', 'travel-monster') , '<span class="author vcard"><a class="url fn n" href="' . esc_url(get_author_posts_url(get_the_author_meta('ID', $author_id))) . '" itemprop="url"><span itemprop="name">' . esc_html(get_the_author_meta('display_name', $author_id)) . '</span></a></span>'); ?>
